...
class CustomMenuBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap("windowadd.png"),QIcon.Normal,QIcon.Off)
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap("windowminimize.png"), QIcon.Normal, QIcon.Off)
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap("windowclose.png"), QIcon.Normal, QIcon.Off)
        close.setIcon(icon)
